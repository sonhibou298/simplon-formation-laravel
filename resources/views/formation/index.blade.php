                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md  col-sm-12">
                        <div class=" col-12 px-0 text-end alert">
                            <a href="{{route('AjoutFormation')}}" class="text-decoration-underline alert-dark  alert-link bg-white"><button type="button" class="btn btn-outline-danger">Ajouter une formation<i class="bi bi-arrow-right"></i></button>
                            </a>
                        </div>
...
{{--                                         class="card-img-top sp-rounded-top-15" alt="Work in Team">--}}
{{--                                    <div class="card-body sp-rounded-bottom-15">--}}
{{--                                        <h5 class="card-title center text-uppercase fw-bold sp-red sp-text-sm">--}}
        ...
        <div class="col-12 px-0">
            <div class="col-10 offset-1">
                ...
                <div class="row align-items-center p-relative">
                    ...
                    <div class="col-md  col-sm-12">
                        <div class=" col-12 px-0 text-end alert">
                            <a href="" class="text-decoration-underline alert-dark  alert-link bg-white"><button type="button" class="btn btn-outline-danger">Ajouter une formation<i class="bi bi-arrow-right"></i></button>
                            </a>
                        </div>
                        <div class="row row-cols-1 row-cols-sm-2 row-cols-lg-3">
                            <div class="my-3 justify-content-center ">
